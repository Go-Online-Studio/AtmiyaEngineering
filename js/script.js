        ...
        <div class="row">
          ...
          <div class="col-lg-auto col-sm-6 mb-4 mb-md-0">
            ...
            <ul class="contact-info">
              ...
              <li>
                <a id="footer_contact"  href="tel:+919426547996">
...
function updateWhatsAppTargets() {
  ...
  const phone = '919426547996';
  
  document.querySelectorAll('.set-url-target').forEach(el => {
    el.href = `${baseUrl}?phone=${phone}`;
    el.target = '_blank';
  });
}
...
const debouncedUpdateWhatsApp = debounce(updateWhatsAppTargets, 250);
window.addEventListener('resize', debouncedUpdateWhatsApp);
